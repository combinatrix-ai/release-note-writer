...
def write_release_note(compare_to: str, tag: str, output: Optional[str]):
    ...
    if output:
        with open(output, "w") as f:
            ...
            # If an output file is specified, write the release note to it and ensure a trailing newline.
            if not release_note.endswith("\n"):
                f.write("\n")
    else:
        # If no output file is specified, print the release note.
        click.echo("Release note:")
        click.echo(release_note)
